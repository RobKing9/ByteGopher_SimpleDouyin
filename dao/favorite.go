...
type FavoriteDao interface {
	...
	GetLikeInfo(userId int64, videoId int64) (model.FavoriteModel, error)
...
func (f *favoriteDao) GetLikeInfo(userId int64, videoId int64) (model.FavoriteModel, error) {
	//创建一条空like结构体，用来存储查询到的信息
	var likeInfo model.FavoriteModel
	...
	if err != nil {
		...
		if "record not found" == err.Error() {
			...
			return model.FavoriteModel{}, nil
		} else {
